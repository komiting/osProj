...
#ifndef OS1_VEZB07_RISCV_HPP
#define OS1_VEZB07_RISCV_HPP
...
public:
    ...
    //ova funkcija ne sme biti inline zato sto ako je inline to ne menja status procesora
